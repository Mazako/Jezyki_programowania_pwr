 ...
 *    Data: Styczeń 2023 r.
 */
package pl.mazak.lab6.phoneBook.client;

import pl.mazak.lab6.phoneBook.model.PhoneBook;
import pl.mazak.lab6.phoneBook.server.PhoneBookServer;
...
public class PhoneBookClient extends JFrame implements ActionListener, KeyListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if  (source == startButton) {
            ...
            String stringBuilder = "Spis komend:\n\n" + PhoneBook.closeInstruction + "\n" +
                    PhoneBook.byeInstruction + "\n" +
                    PhoneBook.deleteInstruction + "\n" +
                    PhoneBook.putInstruction + "\n" +
                    PhoneBook.listInstruction + "\n" +
                    PhoneBook.filesInstruction + "\n" +
                    PhoneBook.getInstruction + "\n" +
                    PhoneBook.replaceInstruction + "\n" +
                    PhoneBook.loadInstruction + "\n" +
                    PhoneBook.saveInstruction + "\n";
            JOptionPane.showMessageDialog(this,
                    stringBuilder,
                    "Instrukcja",
                    JOptionPane.INFORMATION_MESSAGE);
